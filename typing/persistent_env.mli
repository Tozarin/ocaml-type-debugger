...
type can_load_cmis = Can_load_cmis | Cannot_load_cmis of Misc.EnvLazy.log
type 'a t
...
val read : 'a t -> (Persistent_signature.t -> 'a) -> modname -> filepath -> 'a
val find : 'a t -> (Persistent_signature.t -> 'a) -> modname -> 'a
val find_in_cache : 'a t -> modname -> 'a option

val check :
  'a t -> (Persistent_signature.t -> 'a) -> loc:Location.t -> modname -> unit
